...
At the time of writing, [.NET Aspire 9.4 has just been released](https://learn.microsoft.com/en-us/dotnet/aspire/whats-new/dotnet-aspire-9.4), so let's upgrade our solution to use the latest version.

Open the solution in your IDE of choice and update the `AppHost` project to use the latest Aspire SDK version.
