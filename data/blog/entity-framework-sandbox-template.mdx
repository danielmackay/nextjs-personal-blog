...
canonicalUrl: https://beta.dandoescode.com/blog/entity-framework-sandbox-template
---
...
Let me know if you find this useful, or have any suggestions for improvements.  Better yet, for the repo and submit a [pull request]((https://github.com/danielmackay/dotnet-ef-sandbox)).
