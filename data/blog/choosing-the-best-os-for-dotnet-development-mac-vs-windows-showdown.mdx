...
*Figure: Rider compiles code 20% to 140% faster on a Mac*
...
![Performance - Total Requests](/static/images/choosing-the-best-os-for-dotnet-development-mac-vs-windows-showdown/perf1.png)
