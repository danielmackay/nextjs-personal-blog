...
<figure>
  <img src="/static/images/automating-pbi-creation-with-github-copilot/vscode-mcp-extensions.png" alt="VS Code MCP Extensions" style={{maxWidth:'500px', margin: 'auto'}} />
  <figcaption style={{textAlign: 'center'}}>Figure: Installing the GitHub MCP Server in VS Code</figcaption>
</figure>

Find the GitHub MCP Server and install it.

<figure>
  <img src="/static/images/automating-pbi-creation-with-github-copilot/github-mcp.png" alt="GitHub MCP Server"  />
  <figcaption style={{textAlign: 'center'}}>Figure: GitHub MCP Server in VS Code</figcaption>
</figure>
...
<figure>
  <img src="/static/images/automating-pbi-creation-with-github-copilot/github-start-server.png" alt="GitHub MCP Server Authentication" />
  <figcaption style={{textAlign: 'center'}}>Figure: Authenticating the GitHub MCP Server</figcaption>
</figure>
...
<figure>
  <img src="/static/images/automating-pbi-creation-with-github-copilot/prompt-files.png" alt="Creating a prompt file in VS Code" style={{maxWidth:'500px', margin: 'auto'}} />
  <figcaption style={{textAlign: 'center'}}>Figure: Creating a prompt file in VS Code</figcaption>
</figure>
...
<figure>
  <img src="/static/images/automating-pbi-creation-with-github-copilot/create-pbi-prompt.png" alt="Using Copilot Chat with prompt files" style={{maxWidth:'500px', margin: 'auto'}} />
  <figcaption style={{textAlign: 'center'}}>Figure: Using Copilot Chat with prompt files</figcaption>
</figure>

The following PBI was created: 

<figure>
  <img src="/static/images/automating-pbi-creation-with-github-copilot/issue.png" alt="PBI created in GitHub" />
  <figcaption style={{textAlign: 'center'}}>Figure: [PBI created in GitHub](https://github.com/danielmackay/nextjs-personal-blog/issues/150)</figcaption>
</figure>
