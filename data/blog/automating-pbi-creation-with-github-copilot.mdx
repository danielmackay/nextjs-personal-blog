...
- **Copilot Prompt Files**: [Official documentation for prompt files (experimental)](https://code.visualstudio.com/docs/copilot/copilot-customization#_prompt-files-experimental)
