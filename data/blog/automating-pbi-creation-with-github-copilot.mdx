...
```prompt
You are a Scrum Product Owner. Your task is to create a clear and concise PBI...

Title: Create a PBI title...
...
When generating the PBI, reference the [copilot-instructions.md](../copilot-instructions.md) for any additional information...
...
```

This was a game-changer. My PBI generation was now context-aware and tailored to the specific project I was working in.

## The "Aha!" Moment: Making it a Conversation

The final tweak to my prompt was the most powerful, and it was my big "Aha!" moment. I added one simple sentence to the end:

`Ask any questions you need to clarify the requirements before creating the PBI.`

This single line transformed the entire interaction. Instead of a "one-shot" command that might miss nuances, Copilot now engages in a conversation with me. It asks clarifying questions to fill in requirement gaps *before* creating the issue. This collaborative back-and-forth ensures the final PBI is far more accurate and complete. It's not just automation; it's a partnership. 🙌
