...
1. Clone template via `npx degit 'timlrx/tailwind-nextjs-starter-blog#contentlayer'`
...
For each blog post I:

1. Copied MDX file into `/data/blog`
...
Migration on the other hand was tricky. After exporting the comments from Disqus, I found several comment threads were not valid either from old pages or from my local testing. I manually massaged the XML export and then used a node.js [disqus-to-github-discussions](https://github.com/estruyf/disqus-to-github-discussions) importer. I also had to create a [GitHub App](https://docs.github.com/en/developers/apps/building-github-apps/creating-a-github-app) to authenticate with the Graph API and avoid rate limiting.
