...
![OpenCode showing an error for the field keyword](/static/images/configuring-opencode-for-csharp-14/error.png)
...
![OpenCode successfully processing C# 14 code](/static/images/configuring-opencode-for-csharp-14/solution.png)
