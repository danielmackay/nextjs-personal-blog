...
<figure>
  ...
  <figcaption>
    Figure:{' '}
    <a href="https://drive.google.com/file/d/18vXKnWKqms67zZXXLd4rkdVkJpZzqdR2/view">
      PARA Cheat Sheet
    </a>
  </figcaption>
</figure>
...
<figure className="flex flex-col items-center">
  <img
    src="/static/images/organising-notes-with-para/apple-notes-overview.png"
    alt="Apple Notes Overview"
  />
  <figcaption>Figure: Apple Notes Overview</figcaption>
</figure>

<figure className="flex flex-col items-center">
  <img
    src="/static/images/organising-notes-with-para/apple-notes-projects.png"
    alt="Apple Notes Projects"
  />
  <figcaption>Figure: Apple Notes Projects</figcaption>
</figure>

<figure className="flex flex-col items-center">
  <img
    src="/static/images/organising-notes-with-para/apple-notes-archive.png"
    alt="Apple Notes Archive"
  />
  <figcaption>Figure: Apple Notes Archive</figcaption>
</figure>
